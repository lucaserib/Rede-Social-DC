...
<body>
	...
	<section class="main-feed">
		...
		<div class="feed">
			...
			<?php 
				$retrievePosts = \LuCodex\Models\HomeModel::retrieveFriendsPosts();
		...
		<?php }?>
			...
			<div class="friends-request-feed">
				...
				<?php
					foreach(\LuCodex\Models\UsuariosModel::listarAmizadesPendentes() as $key=>$value){
					$usuarioInfo = \LuCodex\Models\UsuariosModel::getUsuarioById($value['enviou']);
