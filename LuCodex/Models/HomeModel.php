	...
	class HomeModel{
		...
		public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				...
				$listaAmigos[$key]['id'] = \LuCodex\Models\UsuariosModel::getUsuarioById($value)['id'];

				$listaAmigos[$key]['nome'] = \LuCodex\Models\UsuariosModel::getUsuarioById($value)['nome'];

				$listaAmigos[$key]['email'] = \LuCodex\Models\UsuariosModel::getUsuarioById($value)['email'];

				$listaAmigos[$key]['ultimo_post'] = \LuCodex\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
